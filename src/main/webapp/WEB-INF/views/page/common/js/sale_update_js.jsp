...
$(function(){
	...
	var business_linkman='${business_linkman}';
	var business_phone='${business_phone}';
	var business_contact_another='${business_contact_another}';
	var business_address='${business_address}';
	var sale_pro='${sale_pro}';
	var sale_pro_number='${sale_pro_number}';
	var sale_pro_uprice='${sale_pro_uprice}';
	var sale_pro_price='${sale_pro_price}';
	var sale_price='${sale_price}';
	var sale_staff='${sale_staff}';
