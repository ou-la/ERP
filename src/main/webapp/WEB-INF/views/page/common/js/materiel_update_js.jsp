...
$(function(){
	var materiel_id='${materiel_id}';
	var materie_name='${materie_name}';
	var materie_type='${materie_type}';
	var materie_specifications='${materie_specifications}';
	var materie_describe='${materie_describe}';
	var materie_price='${materie_price}';
	var materie_company='${materie_company}';
	var materie_number='${materie_number}';
	var materie_supplier='${materie_supplier}';
	var materie_purchase_date='${materie_purchase_date}';
	$("#saveBtn").click(function(){
		...
		$.post("${jpath}/materiel/updateUser",
