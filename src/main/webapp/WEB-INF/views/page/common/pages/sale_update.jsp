			                        ...
			                        <div class="row">
			                            ...
			                            <div class="col-md-4">
			                                <div class="form-group">
			                                    ...
			                                    <input id="business_linkman" class="form-control" value="${business_linkman}" disabled="disabled">
			                                </div>
			                            </div>
			                            ...
			                            <div class="col-md-4">
			                                <div class="form-group">
			                                    ...
			                                    <input id="business_phone" class="form-control" value="${business_phone}" disabled="disabled">
			                                </div>
			                            </div>
			                            ...
			                            <div class="col-md-4">
			                                <div class="form-group">
			                                    ...
			                                    <input id="business_contact_another" class="form-control" value="${business_contact_another}" disabled="disabled">
			                                </div>
			                            </div>
			                            ...
			                            <div class="col-md-4">
			                                <div class="form-group">
			                                    ...
			                                    <input id="sale_pro_number" class="form-control" value="${sale_pro_number}">
			                                </div>
			                            </div>
			                            ...
			                            <div class="col-md-4">
			                                <div class="form-group">
			                                    ...
			                                    <input id="sale_pro_uprice" class="form-control" value="${sale_pro_uprice}" disabled="disabled">
			                                </div>
			                            </div>
			                            ...
			                            <div class="col-md-4">
			                                <div class="form-group">
			                                    ...
			                                    <input id="sale_date" class="form-control" value="${sale_date}" disabled="disabled">
			                                </div>
			                            </div>
...
<%@ include file="../js/sale_update_js.jsp" %>
